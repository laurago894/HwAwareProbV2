...
def convert_psdd(inputFile):


    test=[]

    content_psdd=functions.read_file(inputFile)
    ...
    [literal_assign.update({ii: alphabet_lit[ii]}) for ii in var_list]

    [literal_assign.update({ii: 'F'+str(ii)}) for ii in var_list]
    print('var list ', var_list)
    literal_assign[var_list[-1]]='CL'
